const handlers = {
  get: function (request, reply) {
    return reply.view('existing/licence-details', {
  ...
  post: function (request, reply) {
    ...
    request.session.licenceNumberNine = request.payload.licenceNumberNine


    if (request.session.licenceNumber === 'C7A711' || request.session.licenceNumberNine === 'C7A711') {
    ...
    } else if (request.session.licenceNumber === 'C7A722' || request.session.licenceNumberNine === 'C7A722') {
    ...
    else if (request.session.licenceNumber === 'C7A744' || request.session.licenceNumberNine === 'C7A744') {
      request.session.startText = '2 June 2017'
